package com.ping.pingpicture.infrastructure.api.imagesearch.sub;
...
public class GetSoImageListApi {
	...
	public static List<SoImageSearchResult> getImageList(String imageUrl, Integer start) {
		...
		for (SoImageSearchResult soImageSearchResult : result) {
			...
			soImageSearchResult.setThumbUrl(prefix + soImageSearchResult.getImgkey());
		}
		return result;
	}

	public static void main(String[] args) {
		List<SoImageSearchResult> imageList = getImageList("https://ps.ssl.qhmsg.com/bdr/468_250_/t02a2360f0f6a6aa7a5.jpg", 0);
